 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://calculator.giodabg.org/", wsdlLocation = "http://localhost:8080/CalculatorWSApplication/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://calculator.giodabg.org/", "CalculatorWS");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://calculator.giodabg.org/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.giodabg.org/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
