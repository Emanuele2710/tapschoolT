 ...
 * 
 */
@WebServiceClient(name = "calculator", targetNamespace = "http://prova.org/", wsdlLocation = "http://localhost:8080/ServerWSApplication/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://prova.org/", "calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServerWSApplication/calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://prova.org/", "calculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://prova.org/", "calculatorPort"), Calculator.class, features);
    }
